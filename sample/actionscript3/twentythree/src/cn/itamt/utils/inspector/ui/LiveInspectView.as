package cn.itamt.utils.inspector.ui {
	...
	public class LiveInspectView extends BaseInspectorView {
		public static const ID : String = 'live_inspect_view';
		...
		override public function onTurnOn() : void {
			...
			if(outputer == null)outputer = new DisplayObjectInfoOutPuter();
...
//			tBtnBL.y = bl.y;
		...
		private function resetTransformPointBtns() : void {
			if(tBtnTL && tBtnTL.parent)this.viewContainer.removeChild(tBtnTL);
			if(tBtnTR && tBtnTR.parent)this.viewContainer.removeChild(tBtnTR);
			if(tBtnBL && tBtnBL.parent)this.viewContainer.removeChild(tBtnBL);
			if(tBtnBR && tBtnBR.parent)this.viewContainer.removeChild(tBtnBR);

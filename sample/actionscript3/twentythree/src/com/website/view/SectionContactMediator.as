...
package com.website.view {
    ...
    public class SectionContactMediator extends Mediator implements IMediator {

        public static const NAME:String = "SectionContactMediator";

        public function SectionContactMediator(viewComponent:*) {
